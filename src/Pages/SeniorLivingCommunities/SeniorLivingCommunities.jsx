...
const SeniorLivingCommunities = () => {
    ...
    return (
        <div className="lg:w-[1170px] mx-auto my-12">
            <h1  className="text-center text-3xl tracking-wider text-[#222222] font-medium">Featured Properties for Senior Living Communities</h1>
            <p className="text-[#5C727D] my-6 text-center leading-6 ">Here are two listings displayed with the featured property shortcode, which you can use when you have some special properties to present.</p>
