...
const SingleFamilyHouse = () => {
    ...
    return (
        <div className="lg:w-[1170px] mx-auto my-12 p-6 rounded-lg flex flex-col bg-red-50">
            <h1 className=" text-center text-[32px] font-semibold text-[#222] tracking-tighter animate__animated animate__bounce animate__delay-2s">Single Family House Properties by Area</h1>
            <p className="my-6 text-center text-[#5c727d] leading-6 animate__animated animate__bounce animate__delay-2s">Explore our premier single-family homes in diverse areas. From urban oases  to suburban retreats, find your perfect <br /> property with our List Category shortcode.</p>
