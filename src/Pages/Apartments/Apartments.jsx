...
const Apartments = () => {
    ...
    return (
        <div className="max-w-[1170px] mx-auto my-12">
            <h1  className="text-center text-3xl tracking-wider text-[#222222] font-medium animate__animated animate__bounce animate__delay-2s">Apartments Latest Properties</h1>
